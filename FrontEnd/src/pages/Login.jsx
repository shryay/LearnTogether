        ...
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p className="text-sm mt-6 text-gray-800 dark:text-white">
              Effortlessly access your account and unlock a world of learning opportunities with LearnTogether.
            </p>
            <ul className="list-disc list-inside mt-4 text-sm text-gray-800 dark:text-white">
              <li>Access tailored roadmaps for your learning journey.</li>
              <li>Participate in mock interviews to sharpen your skills.</li>
              <li>Receive expert resume reviews to boost your career prospects.</li>
              <li>Explore numerous resources designed to accelerate your growth.</li>
            </ul>
          ...
          <form className="max-w-md md:ml-auto w-full">
            ...
            <div className="space-y-4">
              <div>
                <input name="email" type="email" autoComplete="email" required className="bg-gray-100 dark:bg-gray-800 w-full text-sm text-gray-800 dark:text-white px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent dark:focus:bg-transparent" placeholder="Email address" />
              </div>
              <div>
                <input name="password" type="password" autoComplete="current-password" required className="bg-gray-100 dark:bg-gray-800 w-full text-sm text-gray-800 dark:text-white px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent dark:focus:bg-transparent" placeholder="Password" />
              </div>
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="text-sm">
                  <Link to="/forgot-password" className="text-blue-600 hover:text-blue-500 font-semibold">
            ...
            <div className="space-x-6 flex justify-center mt-8">
              ...
              <button type="button" className="border-none outline-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="32px" viewBox="0 0 22.773 22.773">
                  <path d="M15.769 0h.162c.13 1.606-.483 2.806-1.228 3.675-.731.863-1.732 1.7-3.351 1.573-.108-1.583.506-2.694 1.25-3.561C13.292.879 14.557.16 15.769 0zm4.901 16.716v.045c-.455 1.378-1.104 2.559-1.896 3.655-.723.995-1.609 2.334-3.191 2.334-1.367 0-2.275-.879-3.676-.903-1.482-.024-2.297.735-3.652.926h-.462c-.995-.144-1.798-.932-2.383-1.642-1.725-2.098-3.058-4.808-3.306-8.276v-1.019c.105-2.482 1.311-4.5 2.914-5.478.846-.52 2.009-.963 3.304-.765.555.086 1.122.276 1.782.569.72.324 1.183.718 1.738.668.607-.052.991-.46 1.61-.735.619-.273 1.193-.344 1.71-.243 1.065.197 2.037.899 2.892 1.801a11.638 11.638 0 0 1 2.015 2.905c.57 1.126.902 2.495 1.086 4.053z" />
                </svg>
              </button>
            </div>
          </form>
