        ...
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p className="text-sm mt-6 text-gray-800 dark:text-white">
              Join us today and start your journey with our intuitively designed registration form.
            </p>
          ...
          <form className="max-w-md md:ml-auto w-full">
            ...
            <div className="space-y-4">
              <div>
                <input name="name" type="text" required className="bg-gray-100 dark:bg-gray-800 w-full text-sm text-gray-800 dark:text-white px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent dark:focus:bg-transparent" placeholder="Name" />
              </div>
              <div>
